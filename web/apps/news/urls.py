...
namespases = make_urls(
    ...
    Url('crud/<pk>/', updateCRUDView.as_view('news_crud_update'), name="crud_update"),
    Url('crud/add/', updateCRUDView.as_view('news_crud_create'), name="crud_create"),
    Url('crud/<pk>/del/', deleteCRUDView.as_view('news_crud_delete'), name="crud_delete"),
)
